...
import { forgotPassword, logIn, signWithGoogle } from "../auth/firebase";
      ...
      >
        ...
        >
          ...
          <div className="flex justify-between">
            <span
              role="button"
              className="links-a font-[0.75em] cursor-pointer decoration-none text-[#701a75] hover:text-[#8f8f8f]"
              // email kısmı dolu olmalı
